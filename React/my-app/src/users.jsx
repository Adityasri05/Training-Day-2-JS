const Users=()=>{
  ...
  const mappedUsers = userData.map((user, index) => ({
    sNo: index + 1,
    image: user.avatar_url,
    username: user.login,
    email: `${user.login}@example.com`,
    phone: `+1-555-${String(index + 100).padStart(3, "0")}`,
    address: `${["New York", "London", "Delhi", "Sydney", "Toronto", "Berlin", "Tokyo"][index % 7]}, ${["USA", "UK", "India", "Australia", "Canada", "Germany", "Japan"][index % 7]}`,
    profile: user.html_url,
  }));

  return (
    <div style={{ padding: "24px", background: "#2953a7" }}>
      <h2 style={{ marginBottom: "16px", color: "#0f172a" }}>User Data</h2>
      <div style={{ overflowX: "auto" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", background: "#151a22" }}>
          <thead>
          ...
          <tbody>
            {mappedUsers.map((user) => (
              <tr key={user.sNo} style={{ borderBottom: "1px solid #e5e7eb" }}>
                <td style={tableCellStyle}>{user.sNo}</td>
                <td style={tableCellStyle}>
                  <img src={user.image} alt={user.username} style={{ width: "40px", height: "40px", borderRadius: "50%" }} />
                </td>
                ...
                <td style={tableCellStyle}>
                  <a href={user.profile} target="_blank" rel="noreferrer" style={{ color: "#2563eb" }}>
                    {user.profile}
                  </a>
                </td>
              </tr>
